...
if(! defined('MAX_WIDTH') )                 define ('MAX_WIDTH', 600);                              // Maximum image width
if(! defined('MAX_HEIGHT') )                define ('MAX_HEIGHT', 600);                         // Maximum image height
