...
class Mp3Meta
{
    ...
    public function __construct($file, $size = 0)
    {
    ...
    {
        return array(
            'bitrate' => (isset($this->mp3data['Bitrate'])) ? (int) $this->mp3data['Bitrate'] : 0,
            'sampling_rate' => (isset($this->mp3data['Sampling Rate'])) ? (int) $this->mp3data['Sampling Rate'] : 0,
            'length_sec' => (isset($this->mp3data['Length'])) ? (int) $this->mp3data['Length'] : 0,
            'length_mm:ss' => (isset($this->mp3data['Length mm:ss'])) ? $this->mp3data['Length mm:ss'] : '0'
        );
    }
