		...
		public function init()
		{
			...
			*/
			...
			$this->write('session', array(
				...
				'encryptionKey' => md5('cH!swe!retReGu7W6bEDRup7usuDUh9THeD2CHeGE*ewr4n39=E@rAsp7c-Ph@pH'),
				'httpOnly' => true,
				'useOnlyCookies' => true,
				'hash' => 'sha512',
			...
			$this->write('slim', array(
				...
				'cookies.secret_key' => md5('Danhorzun!d6Romsy@ocForj!8negJupNucak1Qued@Cowkik6'),
